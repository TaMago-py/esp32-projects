...
Here I made the ___rgb___ go through the __chromatic circle__. For this, I made an __array__ with the __values__ for every color.

If a color reaches a value of 255, it starts to __decrease__ while the next number __increases__. 
...
Definition of __happiness__. I made a system to make music __easier to make__ with the ___buzzer___. I implemented also a __lyrics__ system to use my favorite piece, the ___oled screen___ 😼

in the file named ___music.txt___ I will be uploading the music I made.

here's my __favorite__ one. It doesn't have lyrics, but I made a __banner__ with the __title__ anyways.
...
A simple test that works with any ___digital sensor___... ___I think___. I used it to see how the __sensors__ worked.

I also wanted to try the '___millis()___' function, so, I made that the led __changes__ its state after __half a second__ the sensor is __activated__.
